...
python closure-tools/closure/bin/build/closurebuilder.py --root closure-tools --root website/client --namespace "website" --output_mode=compiled --compiler_jar=closure-tools/compiler.jar > website/static/js/website-compiled.js
